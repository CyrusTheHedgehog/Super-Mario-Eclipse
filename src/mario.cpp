...
SME_PATCH_BL(SME_PORT_REGION(0x8024C3F8, 0x80244184, 0, 0),
...
SME_PATCH_BL(SME_PORT_REGION(0x802565D4, 0x8024e360, 0, 0),
...
SME_PATCH_BL(SME_PORT_REGION(0x80256618, 0x8024e3a4, 0, 0),
...
SME_WRITE_32(SME_PORT_REGION(0x8025C3FC, 0x80254188, 0, 0), 0xFC800018);
SME_WRITE_32(SME_PORT_REGION(0x8025C400, 0x8025418c, 0, 0), 0xD09E00B0);
SME_PATCH_BL(SME_PORT_REGION(0x8025C404, 0x80254190, 0, 0), checkSlideSpeedMulti);
SME_WRITE_32(SME_PORT_REGION(0x8025C408, 0x80254194, 0, 0), 0xFC400890);
SME_WRITE_32(SME_PORT_REGION(0x8025C410, 0x8025419c, 0, 0), 0x60000000);
