...
SME_PATCH_BL(SME_PORT_REGION(0x8025B8C0, 0x8025364c, 0, 0), 
             Patch::Mario::checkGroundSpeedLimit);
SME_WRITE_32(SME_PORT_REGION(0x8025B8C4, 0x80253650, 0, 0), 0xEFFF0072);
SME_WRITE_32(SME_PORT_REGION(0x8024CB00, 0x8024488c, 0, 0),SME_PORT_REGION(0xC162EF70, 0xC162ede8, 0, 0) );
...
SME_PATCH_BL(SME_PORT_REGION(0x8024CC6C, 0x802449f8, 0, 0),
              Patch::Mario::checkJumpSpeedLimit);
SME_WRITE_32(SME_PORT_REGION(0x8024CCF8, 0x80244a84, 0, 0), 0xEC0B007A);
SME_WRITE_32(SME_PORT_REGION(0x8024CD24, 0x80244ab0, 0, 0), 0xEC0B007A);
