...
// camera.cpp
SME_PATCH_B(SME_PORT_REGION(0x80027548, 0x80027600, 0, 0),
...
SME_PATCH_BL(SME_PORT_REGION(0x802A716C, 0x8029f058, 0, 0), Patch::Init::initFirstModel);
SME_PATCH_BL(SME_PORT_REGION(0x802998B4, 0x8029174c, 0, 0), Patch::Init::initFileMods);
SME_PATCH_B(SME_PORT_REGION(0x80280180, 0x80277f0c, 0, 0), Patch::Init::initShineShadow);
...
SME_PATCH_BL(SME_PORT_REGION(0x800397DC, 0x80039894, 0, 0), Patch::Init::fromShadowMarioInit);
...
// mario.cpp
SME_PATCH_B(SME_PORT_REGION(0x802558A4, 0x8024d630, 0, 0), Patch::Mario::addVelocity);
...
SME_PATCH_BL(SME_PORT_REGION(0x802815F0, 0x8027937c, 0, 0), Patch::Mario::canGrabAtNPC);
...
SME_PATCH_BL(SME_PORT_REGION(0x80213314, 0x8020b1f8, 0, 0), Patch::Mario::scaleNPCTalkRadius);
SME_PATCH_BL(SME_PORT_REGION(0x80261C3C, 0x802599c8, 0, 0), Patch::Mario::getTreeClimbMinFall);
...
SME_PATCH_BL(SME_PORT_REGION(0x802619CC, 0x8025975c, 0, 0), Patch::Mario::getTreeClimbMaxFall);
...
SME_WRITE_32(SME_PORT_REGION(0x8025B8BC, 0x80253648, 0, 0), 0x60000000);
SME_PATCH_BL(SME_PORT_REGION(0x8025B8C0, 0x8025364c, 0, 0), Patch::Mario::checkGroundSpeedLimit);
SME_WRITE_32(SME_PORT_REGION(0x8025B8C4, 0x80253650, 0, 0), 0xEFFF0072);
SME_WRITE_32(SME_PORT_REGION(0x8024CB00, 0x8024488c, 0, 0), 0xC162EF70);
SME_WRITE_32(SME_PORT_REGION(0x8024CC50, 0x802449dc, 0, 0), 0xED600072);
SME_WRITE_32(SME_PORT_REGION(0x8024CC60, 0x802449ec, 0, 0), 0x60000000);
SME_WRITE_32(SME_PORT_REGION(0x8024CC64, 0x802449f0, 0, 0), 0x60000000);
SME_WRITE_32(SME_PORT_REGION(0x8024CC68, 0x802449f4, 0, 0), 0x60000000);
SME_PATCH_BL(SME_PORT_REGION(0x8024CC6C, 0x802449f8, 0, 0), Patch::Mario::checkJumpSpeedLimit);
SME_WRITE_32(SME_PORT_REGION(0x8024CCF8, 0x80244984, 0, 0), 0xEC0B007A);
SME_WRITE_32(SME_PORT_REGION(0x8024CD24, 0x80244ab4, 0, 0), 0xEC0B007A);
SME_PATCH_BL(SME_PORT_REGION(0x8024CC2C, 0x802449b8, 0, 0), Patch::Mario::checkJumpSpeedMulti);
SME_WRITE_32(SME_PORT_REGION(0x8024CC30, 0x802449bc, 0, 0), 0x57C5043E);

SME_PATCH_BL(SME_PORT_REGION(0x8003FDAC, 0x8003fbfc, 0, 0),
...
// Hover move on roofs
SME_WRITE_32(SME_PORT_REGION(0x802569BC, 0x8024e748, 0, 0), 0xC02300B0);
